...
import Projeler.Utils.BaseStaticDriver;
...
public class proje4 extends BaseStaticDriver {
    ...
    public static void demoWebShopRegister() {
        ...
        emailInput.sendKeys("deneme233@google.com");

        WebElement passwordInput = driver.findElement(By.id("Password"));
        passwordInput.sendKeys("deneme1234");

        WebElement passwordInput2 = driver.findElement(By.id("ConfirmPassword"));
        passwordInput2.sendKeys("deneme1234");
    ...
    public static void scenario_1() {
        ...
        Assert.assertEquals("deneme233@google.com", successMessage.getText());
    ...
    public static void scenario_2() {
        ...
        WebElement emailInput = driver.findElement(By.id("Email"));
        emailInput.sendKeys("deneme@google.com");
